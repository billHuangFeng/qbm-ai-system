...
async def extract_memories(
    ...
    memory_service: EnterpriseMemoryService = Depends(
        lambda: EnterpriseMemoryService()
    ),
):
    """从评价数据中提取企业记忆"""
    try:
        ...
        raise BusinessError(
            code="MEMORY_EXTRACTION_FAILED", message=f"企业记忆提取失败: {str(e)}"
        )
...
async def search_memories(
    ...
    try:
        ...
        raise BusinessError(
            code="MEMORY_SEARCH_FAILED", message=f"企业记忆搜索失败: {str(e)}"
        )
...
async def get_memories(
    ...
    try:
        ...
        raise BusinessError(
            code="MEMORY_LIST_FAILED", message=f"获取企业记忆列表失败: {str(e)}"
        )
...
async def get_memory(
    ...
    try:
        memory = await memory_service.get_memory_by_id(
            memory_id=memory_id, tenant_id=current_user["tenant_id"]
        )

        if not memory:
            raise BusinessError(code="MEMORY_NOT_FOUND", message="企业记忆不存在")
        ...
        raise BusinessError(
            code="MEMORY_RETRIEVAL_FAILED", message=f"获取企业记忆失败: {str(e)}"
        )
...
async def update_memory(
    ...
    try:
        ...
        raise BusinessError(
            code="MEMORY_UPDATE_FAILED", message=f"更新企业记忆失败: {str(e)}"
        )
...
async def delete_memory(
    ...
    try:
        ...
        raise BusinessError(
            code="MEMORY_DELETE_FAILED", message=f"删除企业记忆失败: {str(e)}"
        )
...
async def record_feedback(
    ...
    try:
        ...
        raise BusinessError(
            code="FEEDBACK_RECORD_FAILED", message=f"记录反馈失败: {str(e)}"
        )
...
async def get_memory_stats(
    ...
    try:
        ...
        raise BusinessError(
            code="MEMORY_STATS_FAILED", message=f"获取企业记忆统计失败: {str(e)}"
        )
...
async def apply_memory(
    ...
    try:
        ...
        application_result = await memory_service.apply_memory(
            memory_id=memory_id, context=context, tenant_id=current_user["tenant_id"]
        )
        ...
        raise BusinessError(
            code="MEMORY_APPLICATION_FAILED", message=f"应用企业记忆失败: {str(e)}"
        )
