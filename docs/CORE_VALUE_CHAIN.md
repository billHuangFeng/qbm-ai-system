...
**关联类型**:
- **产品内在价值-产品特性关联** (`bridge_vpt_pft`): 产品内在价值与产品特性的映射
- **媒体渠道-产品内在价值关联** (`bridge_media_vpt`): 媒体渠道传递的产品内在价值
- **转化渠道-产品内在价值关联** (`bridge_conv_vpt`): 转化渠道对应的产品内在价值
