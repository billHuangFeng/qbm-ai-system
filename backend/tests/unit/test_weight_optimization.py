...
class TestWeightOptimizer:
    ...
    def test_bayesian_optimization(self):
        """测试贝叶斯优化实现"""
        result = self.weight_optimizer._bayesian_optimization(self.X, self.y, "r2", 100)
    ...
    def test_select_best_result(self):
        ...
        optimization_results = {
            ...
            "method2": {
                "r2_score": 0.9,
                "weights": {"feature1": 0.6, "feature2": 0.3, "feature3": 0.1},
            },
            "method3": {
                "r2_score": 0.7,
                "weights": {"feature1": 0.4, "feature2": 0.4, "feature3": 0.2},
            },
        }
