...
class MLPModel:
    ...
    def __init__(self, hidden_layer_sizes: Tuple = (100,), max_iter: int = 1000,
...
class DeepMLPModel:
    ...
    def __init__(self, hidden_layer_sizes: Tuple = (200, 100, 50), max_iter: int = 2000,
                 random_state: int = 42, **kwargs):
        self.model = MLPRegressor(
            hidden_layer_sizes=hidden_layer_sizes,
            max_iter=max_iter,
...
class WideMLPModel:
    ...
    def __init__(self, hidden_layer_sizes: Tuple = (500, 200), max_iter: int = 1500,
                 random_state: int = 42, **kwargs):
        self.model = MLPRegressor(
            hidden_layer_sizes=hidden_layer_sizes,
            max_iter=max_iter,
