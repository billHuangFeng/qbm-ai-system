...
def handle_exceptions(
    default_error: str = "操作失败", log_errors: bool = True, reraise: bool = True
):
    """
    异常处理装饰器
...
def map_exception(
    ...
    if exception_type in EXCEPTION_MAPPING:
        ...
        return bmos_exception_class(message=str(exception), context=context or {})
    else:
        return BMOSBusinessError(message=str(exception), context=context or {})
