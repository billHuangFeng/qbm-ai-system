...
class ScheduledJob:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ScheduledJob":
        ...
        job.last_run = datetime.fromisoformat(data["last_run"]) if data["last_run"] else None
        job.next_run = datetime.fromisoformat(data["next_run"]) if data["next_run"] else None
    ...
    async def pause_job(self, job_id: str) -> bool:
        ...
        try:
            ...
            if job_id in self.jobs:
                ...
                await self.redis_cache.set(f"scheduled_job:{job_id}", self.jobs[job_id].to_dict(), ttl=86400)
