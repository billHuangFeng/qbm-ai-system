...
class TrainingRequest(BaseModel):
    ...
    model_type: str = Field(
        ...,
        description="模型类型: marginal_analysis, timeseries, npv, capability_value",
    )
...
class RetrainRequest(BaseModel):
    ...
    update_strategy: str = Field(
        "incremental", description="更新策略: incremental, full_retrain"
    )
    ...
    try:
        ...
        return {
            ...
            "duration": _calculate_duration(
                training_info["started_at"], training_info["completed_at"]
            ),
        }
