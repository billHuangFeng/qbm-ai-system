...
class TestWeightMonitor:
    ...
    def test_monitor_weights(self):
        """测试权重监控"""
        result = self.weight_monitor.monitor_weights(self.X, self.y, self.weights)
    ...
    def test_monitor_performance(self):
        """测试性能监控"""
        result = self.weight_monitor._monitor_performance(self.X, self.y, self.weights)
        ...
        assert result["performance_trend"] in [
            "improving",
            "declining",
            "stable",
            "unknown",
    ...
    def test_monitor_stability(self):
        """测试稳定性监控"""
        result = self.weight_monitor._monitor_stability(self.X, self.y, self.weights)
    ...
    def test_calculate_performance_trend(self):
        ...
        trend = self.weight_monitor._calculate_performance_trend(
            current_r2, historical_performance
        )
    ...
    def test_update_monitoring_history(self):
        """测试监控历史更新"""
        monitoring_results = {"performance": {"current_r2": 0.8}, "overall_score": 0.8}
