...
class TestAlgorithmIntegration:
    ...
    def test_calculate_optimization_score(self):
        ...
        score = self.algorithm_service._calculate_optimization_score(optimization_results)
    ...
    def test_high_correlation_data(self):
        ...
        # 测试分析
        result = self.algorithm_service.analyze_data_relationships(high_corr_X, high_corr_y)
        assert isinstance(result, dict)
