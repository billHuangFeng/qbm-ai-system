...
class SecureDatabaseService:
    ...
    async def batch_insert(
        self, table: str, columns: List[str], data: List[List[Any]]
    ) -> int:
        """批量插入数据"""
        if not data:
            return 0
    ...
    async def safe_insert(self, table: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """安全的INSERT操作"""
    ...
    async def safe_delete(
        self, table: str, where_clause: str, where_params: List[Any]
    ) -> int:
        """安全的DELETE操作"""
