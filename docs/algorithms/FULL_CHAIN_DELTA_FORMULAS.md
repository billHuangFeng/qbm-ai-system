...
渠道资产构成：
1. 门店网络：门店销售收益 + 门店品牌收益
2. 渠道协议：渠道合作收益 + 渠道效率收益
3. 客户数据库：客户洞察收益 + 精准营销收益
```
...
```
△渠道能力价值 = （门店转化收益 + 渠道复购收益 + 客户洞察收益）× 贡献百分比 ÷ 12
其中：贡献百分比 = 基于销售成果的渠道能力驱动占比
...
| 渠道（销售落地） | 264.84 | 135 | 渠道资产×1.3=需求反馈收集基数；渠道能力×0.8=需求反馈转化率 | 收集客户需求、需求导向销售 |
