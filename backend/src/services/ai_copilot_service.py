...
class AICopilotToolServer:
    ...
    def __init__(self, db_service, cache_service, openai_api_key: str, anthropic_api_key: str):
    ...
    def _register_tools(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "marginal_analysis": {
                ...
                "parameters": ["business_scenario", "decision_variables", "time_horizon"],
                "priority": 1
            },
            "synergy_detection": {
                "name": "协同效应检测",
            ...
            "threshold_analysis": {
                ...
                "parameters": ["metric_data", "threshold_candidates", "sensitivity_level"],
                "priority": 1
            },
            "scenario_simulation": {
                "name": "场景模拟",
                ...
                "parameters": ["scenario_params", "simulation_period", "monte_carlo_runs"],
                "priority": 1
            },
            ...
            "trend_forecasting": {
                ...
                "parameters": ["historical_data", "forecast_horizon", "confidence_level"],
                "priority": 2
            },
            "risk_assessment": {
                "name": "风险评估",
            ...
            "competitor_analysis": {
                ...
                "parameters": ["competitor_list", "analysis_dimensions", "data_sources"],
                "priority": 2
            },
            "market_research": {
                "name": "市场研究",
                ...
                "parameters": ["market_scope", "research_questions", "data_requirements"],
                "priority": 2
            },
            ...
            "strategic_planning": {
                ...
                "parameters": ["strategic_goals", "resource_constraints", "time_horizon"],
                "priority": 3
            },
            "change_impact_analysis": {
                ...
                "parameters": ["change_proposal", "stakeholder_map", "impact_dimensions"],
                "priority": 3
            },
            "resource_optimization": {
                ...
                "parameters": ["resource_pool", "demand_forecast", "optimization_objectives"],
                "priority": 3
            },
            "insight_synthesis": {
                "name": "洞察综合",
    ...
    def _setup_routing_rules(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "context_routing": {
                "analysis_context": ["marginal_analysis", "synergy_detection", "threshold_analysis"],
                "prediction_context": ["trend_forecasting", "scenario_simulation"],
                "research_context": ["market_research", "competitor_analysis", "deep_research"]
            },
    ...
    async def _route_request(self, request: ToolRequest) -> Dict[str, Any]:
        """智能路由请求"""
        # 基于关键词的路由
        if any(keyword in request.context.get("query", "").lower() 
               for keyword in self.routing_rules["priority_routing"]["high_priority_keywords"]):
            # 高优先级请求，选择最快的工具
    ...
    def _select_context_tool(self, request: ToolRequest, context_tools: List[str]) -> Dict[str, Any]:
        """选择上下文相关的工具"""
    ...
    async def _execute_tool(self, tool: Dict[str, Any], request: ToolRequest) -> Dict[str, Any]:
        """执行工具"""
    ...
    async def _execute_marginal_analysis(
        ...
        try:
            ...
            # 执行边际分析
            analysis_result = await self._perform_marginal_analysis(data, decision_variables)
    ...
    async def _execute_synergy_detection(
        ...
        try:
            ...
            # 执行协同效应分析
            synergy_result = await self._detect_synergies(feature_data, target_metric, analysis_depth)
            ...
            return {
                ...
                "optimization_opportunities": synergy_result["optimization_opportunities"]
            }
    ...
    async def _execute_threshold_analysis(
        ...
        try:
            ...
            # 执行阈值分析
            threshold_result = await self._analyze_thresholds(metric_data, threshold_candidates, sensitivity_level)
    ...
    async def _get_analysis_data(self, scenario: str, time_horizon: int) -> pd.DataFrame:
        """获取分析数据"""
        # 从数据库获取相关数据
        query = """
        ...
        result = await self.db_service.execute_query(
            query, 
            {"scenario": scenario, "start_date": start_date}
        )
...
class AgentLoop:
    ...
    async def process_conversation(self, user_input: str, user_id: str, session_id: str) -> Dict[str, Any]:
        """处理对话"""
        try:
            # 解析用户意图
    ...
    async def _determine_required_tools(self, intent: Dict[str, Any]) -> List[Dict[str, Any]]:
        """确定需要的工具"""
    ...
    async def _synthesize_results(self, results: List[ToolResponse], user_input: str) -> Dict[str, Any]:
        """综合结果"""
        # 收集所有洞察和建议
        all_insights = []
        all_recommendations = []
...
class AICopilotAPI:
    ...
    async def chat_endpoint(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 使用Agent Loop处理对话
        response = await self.agent_loop.process_conversation(user_input, user_id, session_id)
        
        return response
    
    async def tool_execution_endpoint(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        """工具执行端点"""
