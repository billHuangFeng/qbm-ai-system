...
class TestWeightValidator:
    ...
    def test_robustness_test(self):
        """测试鲁棒性测试"""
        result = self.weight_validator._robustness_test(
            self.X, self.y, self.weights
        )
    ...
    def test_single_feature_handling(self):
        ...
        result = self.weight_validator.validate_weights(single_X, single_y, single_weights)
    ...
    def test_weight_effectiveness(self):
        ...
        result = self.weight_validator.validate_weights(self.X, self.y, effective_weights)
    ...
    def test_weight_ineffectiveness(self):
        ...
        result = self.weight_validator.validate_weights(self.X, self.y, ineffective_weights)
