...
class TestModelTrainingAPI:
    ...
    def test_train_marginal_analysis_model(
        self, mock_service_class, client, sample_data
    ):
        """测试边际分析模型训练"""
        # 模拟服务
        mock_service = Mock()
        ...
        mock_service.train_marginal_analysis_model.return_value = {
            ...
            "performance_metrics": {"r2_score": 0.85, "mse": 2.5, "mae": 1.2},
            "feature_importance": {
                "feature_1": 0.4,
                "feature_2": 0.35,
                "feature_3": 0.25,
        ...
        response = client.post(
            "/api/v1/models/train/marginal-analysis", json=request_data
        )
    ...
    def test_train_time_series_model(self, mock_service_class, client):
        ...
        mock_service.train_timeseries_model.return_value = {
            ...
            "performance_metrics": {"r2_score": 0.78, "mse": 3.2, "mae": 1.5},
            "forecast_horizon": 12,
        }
    ...
    def test_predict(self, mock_service_class, client):
        ...
        mock_service.predict.return_value = {
            ...
            "confidence_interval": {"lower": 23.0, "upper": 28.0},
        ...
        request_data = {
            "model_id": "test_model_1",
            "input_data": {"feature_1": 12.5, "feature_2": 6.0, "feature_3": 9.0},
        }
    ...
    def test_extract_memory_from_feedback(self, mock_service_class, client):
        ...
        request_data = {
            "feedback_data": {
                ...
                "metrics": {"satisfaction_score": 0.9, "revenue_increase": 0.15},
            }
        }
...
class TestPredictionsAPI:
    ...
    def test_track_prediction_accuracy(self, mock_service_class, client):
        ...
        request_data = {
            ...
            "feature_values": {"feature_1": 12.5, "feature_2": 6.0, "feature_3": 9.0},
        }
...
class TestErrorHandling:
    ...
    def test_model_training_error(self, mock_service_class, client):
        ...
        mock_service = Mock()
        mock_service_class.return_value = mock_service
        mock_service.train_marginal_analysis_model.side_effect = Exception(
            "Training failed"
        )
    ...
    def test_prediction_error(self, mock_service_class, client):
        ...
        request_data = {"model_id": "invalid_model", "input_data": {}}
...
class TestPerformance:
    ...
    def test_large_dataset_handling(self, client):
        ...
        # 测试请求不会超时
        response = client.post(
            "/api/v1/models/train/marginal-analysis", json=request_data, timeout=30
        )
        assert response.status_code in [
            200,
            422,
        ]  # 可能因为数据太大而验证失败，但不应该超时
