...
class ErrorHandler:
    ...
    def handle_bmos_error(self, error: BMOSError, request_id: Optional[str] = None) -> JSONResponse:
        """处理BMOS错误"""
    ...
    def handle_validation_error(self, error: RequestValidationError, request_id: Optional[str] = None) -> JSONResponse:
        """处理验证错误"""
